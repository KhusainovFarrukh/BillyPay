...
public class UserConstants {
    ...
    public static final String ENDPOINT_POSTFIX_SEARCH_BY_USERNAME = "/search";
    ...
    public static final String ENDPOINT_SEARCH_BY_USERNAME = ENDPOINT_USER + ENDPOINT_POSTFIX_SEARCH_BY_USERNAME;
